...
The movie The Avengers is a superhero film directed by Joss Whedon and produced by Marvel Studios. Released in 2012, it brings together characters from the Marvel Cinematic Universe, including Iron Man (Tony Stark), played by Robert Downey Jr., Captain America (Steve Rogers), played by Chris Evans, Thor, played by Chris Hemsworth, and The Hulk (Bruce Banner), played by Mark Ruffalo.

The heroes must work together to stop Loki, Thor’s brother, from using the Tesseract, a powerful energy source, to conquer Earth. The movie was followed by sequels such as Avengers: Age of Ultron (2015), Avengers: Infinity War (2018), and Avengers: Endgame (2019).

The movie Aladdin is an animated musical fantasy film produced by Walt Disney Animation Studios. Released in 1992, it tells the story of Aladdin, a street-smart young man who finds a magical lamp containing a Genie, voiced by Robin Williams.

With the Genie’s help, Aladdin tries to win the love of Princess Jasmine while stopping the evil sorcerer Jafar from using the lamp for his own sinister purposes. A live-action remake was released in 2019, starring Will Smith as the Genie.

The movie Black Panther is a superhero film directed by Ryan Coogler and produced by Marvel Studios. Released in 2018, it stars Chadwick Boseman as T’Challa, the king of Wakanda, a technologically advanced African nation.

T’Challa must protect his throne and his people from Killmonger, played by Michael B. Jordan, who challenges him for the crown. The film explores themes of heritage, responsibility, and identity. A sequel, Black Panther: Wakanda Forever, was released in 2022.

The movie Encanto is an animated musical fantasy film produced by Walt Disney Animation Studios. Released in 2021, it follows the story of Mirabel Madrigal, a young girl in a magical Colombian family where everyone except her has a unique power.

When the family’s magical home begins to crumble, Mirabel must uncover the truth about their gift and save her family. The film features memorable songs, including “We Don’t Talk About Bruno”, and explores themes of family, individuality, and acceptance.
    ...
    for statement in statements:
        ...
        if len(parts) >= 3:
            ...
            if subject and obj and relation:
                # Invert triples with 'present in work'
                if relation.lower() == 'present in work':
                    triples.append((obj, 'characters', subject))
                else:
...
def filter_and_export_triples(triples, output_file='movie_triples3.csv'):
    """
