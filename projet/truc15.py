...
WHERE {
    # Sous-requête pour garantir un seul identifiant par acteur
    {
    ...
    # Extraire les informations des triples d'entrée en utilisant l'identifiant unique
    ?s <https://schema.org/actor> ?actorName ;
       <https://schema.org/identifier> ?uniqueActorId ;
...
output_graph.serialize(destination="output15-b.ttl", format="turtle")